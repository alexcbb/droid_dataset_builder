...
LANGUAGE_INSTRUCTIONS = ['Pick up the apple and put it into the red bowl',
                         'Grab the apple and place it in the red bowl',
                         'Take the apple and drop it into the red bowl',
                         'Pick up the apple and set it into the red bowl',
                         'Hold the apple and put it inside the red bowl',
                         'Lift the apple and drop it into the red bowl',
                         'Take the apple and place it into the red bowl',
                         'Grab the apple and carefully set it into the red bowl',
                         'Pick up the apple and transfer it into the red bowl',
                         'Hold the apple and gently put it in the red bowl',
                         'Take the apple and place it into the red bowl']
...
def _generate_examples(paths) -> Iterator[Tuple[str, Any]]:
    ...
    def _parse_example(episode_path):
        ...
        lang = random.choice(LANGUAGE_INSTRUCTIONS)
